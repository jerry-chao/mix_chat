...
alias MixChat.Repo
alias MixChat.{User, Conversation, Message, ConversationParticipant}
...
inserted_users = Enum.map(users, fn user_attrs ->
...
messages = [
  ...
  %{content: "I'm doing well, thanks! How about you?", user_id: lina.id, conversation_id: conv2.id}
]
